# Generated by Django 5.2 on 2025-04-22 20:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parentarticlecategory', to='article.articlecategory', verbose_name='دسته بندی والد')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=100, null=True, verbose_name='نام و نم خانوادگی')),
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='articlecomment_set', to='article.articlecomment', verbose_name='والد')),
